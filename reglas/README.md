...
1. Todo el proyecto gbpublisher utiliza sintaxis específica de Gambas — NO asumir Visual Basic
2. SIEMPRE, ante la más mínima duda sobre sintaxis o el uso de cualquier componente, se debe consultar la documentación oficial antes de responder, esto vale para Gambas, Docbook, Markdown, XML, XSL, Saxon, LaTeX y W3C
3. No se debe suponer o imaginar NADA; todo el código debe tener base documental respaldatoria actualizada
4. Si una firma o componente no se puede verificar en la documentación oficial, se debe aclarar de manera explícita y proponer un mini-test antes de comprometer código en el proyecto
...
2. Ejemplo: `' ESTA ES LA EXPLICACIÓN DE LA FUNCIÓN`
