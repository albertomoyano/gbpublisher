...
- **Fecha release**: 24 de mayo de 2026
- **Additional Use Grant**: Véase abajo
- **Change Date**: Cinco (5) años desde la fecha de release de esta versión
- **Change License**: GNU GPL v3.0 o posterior (GPL-3.0-or-later)
...
Cada versión publicada del Software Licenciado está sujeta a su propia Fecha de Cambio (Change Date), definida como cinco (5) años a partir de la fecha de publicación de dicha versión.

A partir de su respectiva Change Date, esa versión específica del Software Licenciado se regirá exclusivamente por los términos de la GNU General Public License v3.0 o posterior (GPL-3.0-or-later).

Las versiones posteriores del Software Licenciado publicadas con posterioridad estarán sujetas a su propia Fecha de Cambio y no se verán afectadas por la conversión de versiones anteriores.
...
Texto adaptado de [https://mariadb.com/bsl11/](https://mariadb.com/bsl11/)

El Licenciante otorga el derecho a copiar y modificar el Software Licenciado solo para el Uso Permitido. Cualquier otro uso queda prohibido.

Efectivo en la Fecha de Cambio correspondiente a cada versión, la Licencia cambiará automáticamente a la Licencia de Cambio especificada.
...
## Texto Completo de la GPL-3.0 (Licencia de Cambio)
