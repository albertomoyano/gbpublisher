...
\IfFileExists{\gbarchivobib}{%
  ...
  \PackageWarning{gbpublisher}{No se encontro \gbarchivobib:
    las citas saldran sin resolver}}
...
% ============================================================
% 8. ENLACES Y METADATOS DEL PDF
% ------------------------------------------------------------
% hyperref SE CARGA AL FINAL DEL PREÁMBULO, DESPUÉS DE TODO
% LO DEMÁS, QUE ES COMO CORRESPONDE. COMO ESTA CAPA VA ANTES
% DE LA ESTÉTICA, SE DIFIERE CON \AtEndPreamble DE etoolbox.
%
% LAS OPCIONES DE COLOR NO VAN ACÁ: VAN POR \hypersetup, QUE
% SÍ SE SUPERPONE. ASÍ hyperref SE CARGA UNA SOLA VEZ Y NO
% HACE FALTA DUPLICAR EL \usepackage PARA EL MODO IMPRENTA.
% LA ESTÉTICA REDEFINE \gbopcioneshyper.
% ============================================================
...
\AtEndPreamble{%
  ...
  \usepackage{hyperxmp}%
  % \hypersetup NO EXPANDE SU ARGUMENTO ANTES DE PARSEAR LAS
  % CLAVES: PASARLE LA MACRO A SECAS DA
  % "Undefined key `colorlinks=true, ...'". HAY QUE EXPANDIRLA
  % A MANO. VERIFICADO CON LuaLaTeX / TeX Live 2023.
  \expandafter\hypersetup\expandafter{\gbopcioneshyper}%
  % XMP CON Dublin Core. hyperref SOLO LLENA EL DICCIONARIO
  % Info HEREDADO, QUE NO TIENE LUGAR PARA ISBN NI LICENCIA.
  \hypersetup{
    pdftitle={\gbtitulo},
    pdfauthor={\gbautores},
    pdfsubject={\gbsubtitulo},
    pdfkeywords={\gbpalabrasclave},
    pdfpublisher={\gbeditorial},
    pdfdate={\gbanio},
    pdfcopyright={\gblicencia},
    pdflicenseurl={\gburllicencia}
  }%
}
...
\newcommand{\gbTextoColofon}{%
  ...
  gbpublisher~\gbversion, a partir de un flujo de trabajo
  reproducible. Las familias tipográficas utilizadas son
  \gbfuentetexto\ para el texto y \gbfuentetitulos\ para los
  títulos. El formato de página es \gbnombreformato.
  Proyecto disponible en
  \texttt{https://github.com/albertomoyano/gbpublisher}.}
