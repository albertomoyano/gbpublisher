...
\usepackage[allcolors=magenta,unicode,colorlinks]{hyperref}
\usepackage{easyReview}

% referencias
%\addbibresource{./files/<proyecto viejo>.bib}% para archivos heredados de la version de gbTeXpublisher
%\addbibresource{./files/<poner nombre del proyecto>.bib}
